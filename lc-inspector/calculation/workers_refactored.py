"""
Worker module for the LC-Inspector application.
...
class Worker(QThread):
    ...
    This class handles the concurrent processing of data files.
    It emits signals to indicate progress and completion.
