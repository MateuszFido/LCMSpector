...
class View(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.logXCheckBox = QtWidgets.QCheckBox(parent=self.tabQuantitation)
        self.logXCheckBox.setObjectName("logXCheckBox")
        self.logYCheckBox = QtWidgets.QCheckBox(parent=self.tabQuantitation)
        self.logYCheckBox.setObjectName("logYCheckBox")
        self.logScaleLayout.addWidget(self.logXCheckBox)
        self.logScaleLayout.addWidget(self.logYCheckBox)
        self.gridLayout_top_right.addLayout(self.logScaleLayout, 1, 1, 1, 1)
        self.canvas_calibration = pg.PlotWidget()
        self.canvas_calibration.setObjectName("canvas_calibration")
        self.gridLayout_top_right.addWidget(self.canvas_calibration, 2, 0, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.logXCheckBox.setText(_translate("MainWindow", "Log X"))
        self.logYCheckBox.setText(_translate("MainWindow", "Log Y"))
