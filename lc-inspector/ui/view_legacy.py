...
class View(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setToolTip("LC-Inspector")
        ...
        self.gridLayout_3.addWidget(self.caution, 3, 4, 1, 2)
        ...
        # Add MS and annotation file lists to the tab
        ...
        # Set up the browse annotations button
        ...
        # Set up the mass resolution label
        ...
        self.comboBox_2 = QtWidgets.QComboBox(parent=self.tab_results)
        self.comboBox_2.setGeometry(QtCore.QRect(320, 30, 241, 26))
        self.comboBox_2.setObjectName("comboBox_2")
        self.label_5 = QtWidgets.QLabel(parent=self.tab_results)
        self.label_5.setEnabled(True)
        self.label_5.setGeometry(QtCore.QRect(239, 30, 72, 21))
        self.label_5.setObjectName("label_5")
        self.layoutWidget1 = QtWidgets.QWidget(parent=self.tab_results)
        ...
        self.tabWidget.setTabEnabled(self.tabWidget.indexOf(self.tab_results), False)  # Disable the second tab
